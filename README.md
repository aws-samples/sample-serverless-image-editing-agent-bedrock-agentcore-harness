...
- **Per-invocation model switching.** The frontend routes basic chat to [Claude Haiku](https://docs.aws.amazon.com/bedrock/latest/userguide/model-card-anthropic-claude-haiku-4-5.html) and edits to Claude Sonnet 4.6. The agent preserves conversation context across model switches.
...
- [Python 3.13](https://www.python.org/downloads/) (for Lambda function runtimes).
