...
1. A React frontend hosted on AWS Amplify where users upload images, draw masks, and enter editing instructions.
2. An AWS Lambda proxy that acts as a security boundary between browser credentials and the harness API, and controls which system prompts are allowed.
